...
# else returns {"status":"success","data":{}}'
response2 = requests.get('https://staging-api.xtendops.com/timekeeping/attendance/session', headers=headers2)
...
response3 = requests.post('https://staging-api.xtendops.com/timekeeping/attendance/logout', headers=headers2, json=json_data2)

d = json.loads(response3.text)

# Logout Time: 2022-12-07T11:56:49.000Z - Success: True - ID: 367189
print('Logout Time:', d['attendanceLog']['logoutTime'], '-', 'Success:', d['success'], '-', 'ID:', d['attendanceLog']['id'])